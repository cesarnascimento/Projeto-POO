	...
	public void painelAdministrador(Funcionario funcionario) throws ChamadoNaoExistente, IOException, ClassNotFoundException, FuncionarioNaoExistente {
		...
		while (running) {
			...
			if (opcao == 1) {
				...
				id = Integer.parseInt(sc.nextLine());
				Chamado chamado = negocioChamado.buscarChamado(id);
				...
				Funcionario buscado = negocioFuncionario.buscarFuncionario(id);

				if (funcionario != null) {
					System.out.println(buscado.getNomeCompleto() + ", " + buscado.getCargo());
				} else {
				...
				System.out.println("Entre com o ID do funcionario que deseja alterar:");
				id = Integer.parseInt(sc.nextLine());

				Funcionario funci = negocioFuncionario.buscarFuncionario(id);

				if (funci != null) {
					System.out.println("Digite o novo login do funcionário de ID " + funci.getId());
					funci.setLogin(sc.nextLine());
					System.out.println("Digite a nova senha: ");
					funci.setSenha(sc.nextLine());
					System.out.println("Digite seu nome completo: ");
					funci.setNomeCompleto(sc.nextLine());

					negocioFuncionario.alterarFuncionario(funci.getId(), funci);
					System.out.println("Chamado de número " + '[' + funci.getId() + ']' + " alterado com sucesso!");
				} else {
					System.out.println("Não existe um chamado com esse ID.");
				}
			} else if (opcao == 11) {
